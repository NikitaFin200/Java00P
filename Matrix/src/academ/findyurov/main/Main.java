...
import static academ.findyurov.matrix.Matrix.mul;
...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("Columns quantity = " + matrix2.getColumnCount());
        System.out.println("Rows quantity = " + matrix2.getRowCount());
        System.out.println();
